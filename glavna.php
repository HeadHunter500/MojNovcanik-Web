	...
	<body>
		<div id="glavni">
			...
			<?php 
				...
				{
					echo '<header><h1>MOJ NOVČANIK - '.$_SESSION['username'].'</h1></header>';
				}
				
				else echo '<header><h1>MOJ NOVČANIK - Korisnik</h1></header>';
				...
				{
					echo '<p id="stanje">Stanje novčanika:<br/> '.$ukupanIznos.' kn</p>';
				}
